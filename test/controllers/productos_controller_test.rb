...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { categoria_id: @producto.categoria_id, descripcion: @producto.descripcion, nombre: @producto.nombre, precio: @producto.precio }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { categoria_id: @producto.categoria_id, descripcion: @producto.descripcion, nombre: @producto.nombre, precio: @producto.precio }
    assert_redirected_to producto_path(assigns(:producto))
  end
